...
#    if ztrans== 0:
#    matnew1.use_transparency = False
#    elif ztrans== 1:
#    matnew1.use_transparency = True
#    matnew1.transparency_method='Z_TRANSPARENCY'
def Prs(s):
    if  s.prs=='1':
...
class OBJECT_OT_add_object(bpy.types.Operator, AddObjectHelper):
    ...
    bl_label = "Pencere"
    bl_description = "Pencere Olustur"
